...
#SBATCH --mem=8000M
#SBATCH -o /storage/douyanmeiLab/lulu/mutpipe/TCGA_wu/22_3_9/WGS/log/DNAcopy/%x_%J_out.txt
#SBATCH -t 120:00:00
...
snakemake --rerun-incomplete -j 100 --restart-times 0 --latency-wait 120 --keep-going --cluster "sbatch -p amd-ep2,intel-e5 -q large -c 1 -t 12:00:00 --mem=6G -o /storage/douyanmeiLab/lulu/mutpipe/TCGA_wu/22_3_9/WGS/log/DNAcopy/%x_%J_out.txt"
