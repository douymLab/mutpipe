#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/home/dell/anaconda3/envs/strelka/bin/configureStrelkaSomaticWorkflow.py --normalBam demo/test.normal.bam --tumorBam demo/test.tumor.bam --referenceFasta /mnt/HPCstorage/yanmei/resources/Homo_sapiens_assembly38.fasta --exome --callRegions /mnt/HPCstorage/yanmei/PCAWG_workflows/Agilent_SureSelect_V7/Padded_addchrM.sorted.bed.gz --runDir demo/strelka_somatic/test_strelka'
#
...
sys.path.append(r'/home/dell/anaconda3/envs/strelka/share/strelka-2.9.10-1/lib/python')
...
main(r"/home/dell/mutpipe/strelka2/demo/strelka_somatic/test_strelka/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
